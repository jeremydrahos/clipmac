...
root.bind('<<QuitApp>>', lambda event: root.quit())
...
icon_thread = threading.Thread(target=create_systray, name='clipMAC-tray')
listener_thread = threading.Thread(target=listener_loop, name='clipMAC-hotkey')
